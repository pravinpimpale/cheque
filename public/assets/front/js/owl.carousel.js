!(function (t, e, i, s) {
  ...
  (n.Defaults = {
    ...
    (n.prototype.normalize = function (t, e) {
      ...
      return (
        !this.isNumeric(t) || 1 > i ? (t = s) : (0 > t || t >= i + n) && (t = ((((t - n / 2) % i) + i) % i) + n / 2), t
      );
    }),
    ...
    (n.prototype.maximum = function (t) {
      ...
      if (n.loop) o = this._clones.length / 2 + this._items.length - 1;
        ...
        for (
          ...
          e-- && ((i += this._items[e].width() + this.settings.margin), !(i > s));
    ...
    (n.prototype.to = function (t, e) {
      ...
      this.settings.loop
        ? (!this.settings.rewind && Math.abs(n) > r / 2 && (n += -1 * o * r),
          (t = i + n),
          (s = ((((t - a) % r) + r) % r) + a),
          s !== t && h >= s - n && s - n > 0 && ((i = s - n), (t = s), this.reset(i)))
    ...
    (n.prototype.onTransitionEnd = function (t) {
      return t !== s && (t.stopPropagation(), (t.target || t.srcElement || t.originalTarget) !== this.$stage.get(0))
        ? !1
        ...
        var s,
          ...
          p = function (t) {
            (n = '<div class="owl-video-play-icon"></div>'),
              (s = c.lazyLoad
                ? '<div class="owl-video-tn ' + l + '" ' + h + '="' + t + '"></div>'
  ...
  (function (t, e, i, s) {
    ...
    l.csstransitions() &&
      ...
      l.csstransforms() &&
        ((t.support.transform = new String(o('transform'))), (t.support.transform3d = l.csstransforms3d()));
  })(window.Zepto || window.jQuery, window, document);
