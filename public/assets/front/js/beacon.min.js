  ...
  var e = {
      ...
      508: function (e, t, n) {
        ...
        e.exports = function (e, t, n) {
          ...
          if (((a[6] = (15 & a[6]) | 64), (a[8] = (63 & a[8]) | 128), t)) for (var c = 0; c < 16; ++c) t[o + c] = a[c];
          return t || i(a);
        };
      },
      168: function (e, t, n) {
          ...
          !(function () {
              ...
              if (s && p && p.token) {
                ...
                var L = p && (void 0 === p.spa || !0 === p.spa),
                    ...
                    var a = (function (r) {
                      var o,
                        ...
                        d = {
                          ...
                          startTime: F(),
                          versions: { fl: p ? p.version : '', js: '2024.6.1', timings: 1 },
                          pageloadId: l,
                          location: f,
                          nt: S,
                          serverTimings: I()
                      ...
                      return (
                        ...
                        p && (p.icTag && (d.icTag = p.icTag), (d.siteToken = p.token)),
                    ...
                    a &&
                      ...
                      p &&
                        ...
                        void 0 !== p.forward &&
                          ...
                          (0, o.sendObjectBeacon)('', a, function () {}, !1, p.forward.url)));
                  },
                  B = function () {
                    var t = (function () {
                      ...
                      return (
                        ...
                        E &&
                          ['lcp', 'fid', 'cls', 'fcp', 'ttfb', 'inp'].forEach(function (e) {
                            (r[e] = { value: -1, path: void 0 }), E[e] && void 0 !== E[e].value && (r[e] = E[e]);
                          }),
                        O(r),
                        r
                      );
                  ...
                  R = function () {
                    ...
                    t ? t.then(P) : P(), (w = { id: l, url: e(), ts: new Date().getTime(), triggered: !0 });
                  };
                ...
                var A = function () {
                  ...
                  _ = function (e) {
                    v.push({ id: l, url: e, ts: new Date().getTime() }), v.length > 3 && v.shift();
                  };
                L &&
                  ((u = e()),
                  (function (t) {
                    ...
                    if (r) {
                      ...
                      (t.pushState = function (o, a, c) {
                        ...
                        return (
                          ...
                          s &&
                            (A() &&
                              (((null == w ? void 0 : w.url) == u && (null == w ? void 0 : w.triggered)) || P(u), _(u)),
                            i()),
                          r.apply(t, [o, a, c])
                        );
                      }),
                        window.addEventListener('popstate', function (t) {
                          A() &&
                            (((null == w ? void 0 : w.url) == n && (null == w ? void 0 : w.triggered)) || P(n), _(n)),
                            (n = e()),
                            i();
                        });
                    }
            ...
            function x(e) {
              ...
              switch (
                ...
                'INP' !== e.name && (E[e.name.toLowerCase()] = { value: e.value, path: u }),
                e.name)
              ) {
                case 'CLS':
                  (c = e.attribution) &&
                    ...
                    (E.cls.previousRect =
                      null === (n = c.largestShiftSource) || void 0 === n ? void 0 : n.previousRect));
                  break;
                case 'FID':
                ...
                case 'LCP':
                  (c = e.attribution) &&
                    ...
                    (E.lcp.fp =
                      null === (a = null === (o = c.lcpEntry) || void 0 === o ? void 0 : o.element) || void 0 === a
                        ? void 0
            ...
            function O(e) {
              if ('function' == typeof s.getEntriesByType) {
                ...
                (e.timingsV2 = {}),
                  n &&
                    n[0] &&
                    (n[0].nextHopProtocol && (r.nextHopProtocol = n[0].nextHopProtocol),
      ...
      752: function (e, t) {
        ...
        (t.__esModule = !0),
          ...
          (t.sendObjectBeacon = function (e, t, n, r, i) {
            ...
            var o =
                i ||
                (t.siteToken && t.versions.fl ? '/cdn-cgi/rum?'.concat(e) : '/cdn-cgi/beacon/performance?'.concat(e)),
              a = !0;
          ...
          var t,
                ...
                for (; e && 9 !== e.nodeType; ) {
                  var r = e,
                    i = r.id
                      ? '#' + r.id
                      : u(r) +
                        (r.classList && r.classList.value && r.classList.value.trim() && r.classList.value.trim().length
            ...
            z = function () {
              'interactionCount' in performance ||
                o ||
                (o = m('event', q, { type: 'event', buffered: !0, durationThreshold: 0 }));
            },
            U = [200, 500],
            J = 0,
            W = function () {
                  ...
                  P(function () {
                    ...
                    var r,
                      ...
                      o = function (e) {
                        ...
                        var t,
                          n = ((t = Math.min(Q.length - 1, Math.floor(W() / 50))), Q[t]);
                    ...
                    var n,
                      ...
                      o = function (e) {
                        ...
                        t &&
                          ...
                          ((i.value = Math.max(t.startTime - v(), 0)), (i.entries = [t]), n());
                      },
