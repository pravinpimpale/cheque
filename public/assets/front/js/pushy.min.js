!(function (a) {
  ...
  function d() {
    g.hasClass(k)
      ? (h.addClass(l), g.animate({ left: '0px' }, r), i.animate({ left: s }, r), j.animate({ left: s }, r))
      : (h.addClass(m), g.animate({ right: '0px' }, r), i.animate({ right: s }, r), j.animate({ right: s }, r)),
      q && q.focus();
  }
  function e() {
    g.hasClass(k)
  ...
  var w = (function () {
    ...
    if (null !== document.body) {
      ...
      for (var d in c)
        void 0 !== a.style[d] &&
          ((a.style[d] = 'translate3d(1px,1px,1px)'), (b = window.getComputedStyle(a).getPropertyValue(c[d])));
