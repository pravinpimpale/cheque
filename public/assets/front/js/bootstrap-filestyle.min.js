  ...
  i.prototype = {
    ...
    placeholder: function (e) {
      return void 0 === e
        ...
        : ((this.options.placeholder = e), void this.$elementFilestyle.find('input').attr('placeholder', e));
    },
    text: function (e) {
      return void 0 === e
        ? this.options.text
        : ((this.options.text = e), void this.$elementFilestyle.find('label .text').html(this.options.text));
    },
    btnClass: function (e) {
      return void 0 === e
    ...
    badgeName: function (e) {
      return void 0 === e
        ...
        : ((this.options.badgeName = e),
          void this.$elementFilestyle.find('.badge').attr({ class: 'badge ' + this.options.badgeName }));
    },
    htmlIcon: function (e) {
    ...
    constructor: function () {
      ...
      ('' !== s && s) || ((s = 'filestyle-' + t), i.$element.attr({ id: s }), t++),
        ...
        i.$elementFilestyle
          .find('[name="filedrag"]')
          .css({ position: 'absolute', width: '100%', height: i.$elementFilestyle.height() + 'px', 'z-index': -1 }),
        ...
        i.$element.change(function () {
          ...
          i.options.badge
            ? 0 == i.$elementFilestyle.find('.badge').length
              ? i.$elementFilestyle
                  .find('label')
                  .append(' <span class="badge ' + i.options.badgeName + '">' + e.length + '</span>')
              : 0 == e.length
            ...
            if (
              ...
              i.options.badge
                ? 0 == i.$elementFilestyle.find('.badge').length
                  ? i.$elementFilestyle
                      .find('label')
                      .append(' <span class="badge ' + i.options.badgeName + '">' + n.length + '</span>')
                  : 0 == n.length
                  ? i.$elementFilestyle.find('.badge').remove()
